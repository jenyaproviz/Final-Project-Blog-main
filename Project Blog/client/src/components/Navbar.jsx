...
export const Navbar = () => {
  ...
  const avatar =
    user && user.avatarUrl ? (
      ...
      <span className="w-10 h-10 flex items-center justify-center rounded-full bg-pink-500 text-white text-lg font-bold shadow">
  ...
  return (
    <nav className="w-full px-2 sm:px-6 py-3 flex justify-between items-center border-b border-gray-800 shadow-md">
      <div className="flex items-center gap-3">
        {avatar}
        <span className="ml-2 text-pink-400 text-lg font-semibold tracking-wide">
